...
def model_deepFlavourReference(Inputs,nclasses,dropoutRate=0.1,momentum=0.6):
    """
    ...
    flavour_pred=Dense(nclasses, activation='linear',kernel_initializer='lecun_uniform',name='ID_pred')(x)
...
c = Input(shape=(25,6))
d = Input(shape=(4,12))
model_nosoftmax = model_deepFlavourReference([a,b,c,d],nclasses)

model_nosoftmax.compile(learningrate=0.003,
                             loss='categorical_crossentropy',
                             optimizer='Adam')
model_nosoftmax.summary()
model=load_model('DataStuff/DeepFlavour_noRNN.h5',custom_objects=global_loss_list)
model.save_weights('DataStuff/DeepFlavour_noRNN_weights.h5')                                                                                                                                         
model_nosoftmax.load_weights('DataStuff/DeepFlavour_noRNN_weights.h5')
model_nosoftmax.compile(learningrate=0.003,loss='categorical_crossentropy', optimizer='Adam')
model_nosoftmax.save('DataStuff/DeepFlavour_noRNN_nosoftmax.h5')
