...
model=load_model('DataStuff/small_DeepCSV2.h5')
model.save_weights('DataStuff/small_DeepCSV2_weights.h5')                                                                                                                                              
model_nosoftmax.load_weights('DataStuff/small_DeepCSV2_weights.h5')
model_nosoftmax.compile(learningrate=0.003,
                             loss='categorical_crossentropy',
                             optimizer='Adam')
model_nosoftmax.save('DataStuff/small_DeepCSV2_nosoftmax.h5')
