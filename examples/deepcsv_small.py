...
x = np.load('DataStuff/Numpy_SkimDeepCSV/skimDeepCSV_features_0.npy')
y = np.load('DataStuff/Numpy_SkimDeepCSV/skimDeepCSV_truth_0.npy')
x = x[:500000]
y = y[:500000]


model=load_model('DataStuff/small_DeepCSV2_nosoftmax.h5')
#model=load_model('DataStuff/CurrentDeepCSV_nosoftmax.h5')
...
labels = ['jet_pt', 'jet_eta','TagVarCSV_jetNSecondaryVertices',
          ...
          'TagVarCSV_vertexCategory', 'TagVarCSV_trackSip3dValAboveCharm',
