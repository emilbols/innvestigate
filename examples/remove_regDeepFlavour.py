...
model=load_model('DataStuff/DeepFlavour.h5',custom_objects=global_loss_list)
model.layers.pop()
model.layers.pop()
model.layers.pop()
model.save_weights('DataStuff/DeepFlavour_weights.h5')                                                                                                                                         
model_nosoftmax.load_weights('DataStuff/DeepFlavour_weights.h5')
model_nosoftmax.compile(learningrate=0.003,loss='categorical_crossentropy', optimizer='Adam')
model_nosoftmax.save('DataStuff/DeepFlavour_nosoftmax.h5')
